...
const EMAIL = 'qa-trainer-2@example.com';
...
(async () => {
  ...
  await page.screenshot({ path: `${SHOT_DIR}/03a-role-step-before-click.png` });

  // Click directly on the "Trainer" title text within its card
  await page.click('p:has-text("Trainer")');
  await page.screenshot({ path: `${SHOT_DIR}/03b-role-step-after-click.png` });

  await page.click('button:has-text("Continue")');
  await page.waitForTimeout(2000);
  await page.screenshot({ path: `${SHOT_DIR}/03c-after-role-continue.png` });
